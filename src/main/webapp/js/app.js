/* sendJSON()
 * request object is the variables we want to send to the API
 * handle response is a function, passed as a callback, that handles the API response
 *  - There are several handlers for the response, be sure to pass the right one for the 
